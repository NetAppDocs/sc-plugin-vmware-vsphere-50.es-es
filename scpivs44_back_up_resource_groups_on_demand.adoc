...
.Pasos
. En el panel de navegación izquierdo del plugin SCV, haga clic en *Resource Groups*, seleccione un grupo de recursos y, a continuación, seleccione image:scpivs44_image38.png["Icono Reproducir"] *Run Now* para iniciar el backup.
