...
[role="lead"]
El registro de auditoría es una colección de eventos en un orden cronológico, que se escribe en un archivo dentro del dispositivo. Los archivos de registro de auditoría se generan en `/var/log/netapp/audit` la ubicación, y los nombres de los archivos siguen una de las siguientes convenciones de nomenclatura:
